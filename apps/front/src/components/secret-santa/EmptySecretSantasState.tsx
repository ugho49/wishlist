...
export type EmptySecretSantasStateProps = {
  onCreateClick: () => void;
  sx?: SxProps<Theme>;
};

export const EmptySecretSantasState = ({ onCreateClick, sx }: EmptySecretSantasStateProps) => (
  <EmptyStateContainer sx={sx}>
    ...
    <Box sx={{ textAlign: 'center' }}>
      <EmptyStateTitle>Aucun Secret Santa pour le moment</EmptyStateTitle>
      <EmptyStateSubtitle>
        Lancez un Secret Santa depuis un évènement dont vous êtes organisateur, ou rejoignez-en un.
      </EmptyStateSubtitle>
    </Box>

    <CreateButton variant="contained" color="primary" onClick={onCreateClick} startIcon={<AddIcon />}>
