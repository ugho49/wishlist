  ...
  return (
    <PageContainer>
      <ContentWrapper maxWidth="md">
        ...
        <SectionContent>
          Chez Wishlist, nous nous engageons à protéger votre vie privée et vos données personnelles. Cette politique de
          confidentialité explique comment nous collectons, utilisons, stockons et protégeons vos informations lorsque
        ...
        <SectionContent>
          <strong>Informations techniques :</strong> Adresse IP, type de navigateur, système d'exploitation, données de
          connexion et d'utilisation du service.
        </SectionContent>
        ...
        <SectionContent>
          Nous conservons vos données personnelles aussi longtemps que votre compte est actif ou selon les besoins pour
          vous fournir nos services. Vous pouvez demander la suppression de votre compte et de vos données à tout
          moment.
        </SectionContent>
        ...
        <SectionContent>
          ...
          changement significatif par e-mail ou via notre plateforme.
        </SectionContent>
