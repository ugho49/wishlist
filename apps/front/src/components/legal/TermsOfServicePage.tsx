    ...
    <>
      ...
      <PageContainer>
        <ContentWrapper maxWidth="md">
          ...
          <SectionContent>
            Bienvenue sur Wishlist ! Ces conditions générales d'utilisation régissent votre accès et votre utilisation
            de notre plateforme de partage de listes de souhaits et d'organisation d'événements.
          </SectionContent>
          ...
          <SectionContent>
            <strong>Responsabilité :</strong> Vous êtes seul responsable du contenu que vous publiez. Vous garantissez
            que ce contenu ne porte pas atteinte aux droits de tiers et respecte la législation applicable.
          </SectionContent>
