...
export const user = pgTable(
  'user',
  {
    ...
    birthday: date(),
    clothingSize: varchar('clothing_size', { length: 20 }),
    shoeSize: varchar('shoe_size', { length: 20 }),
    giftNotes: varchar('gift_notes', { length: 500 }),
    addressLine1: varchar('address_line1', { length: 120 }),
    addressLine2: varchar('address_line2', { length: 120 }),
