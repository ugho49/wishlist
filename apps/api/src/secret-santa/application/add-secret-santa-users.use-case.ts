...
import { AddSecretSantaUsersCommand, AddSecretSantaUsersResult } from '../domain/command/add-secret-santa-user.command'
...
@CommandHandler(AddSecretSantaUsersCommand)
export class AddSecretSantaUsersUseCase implements IInferredCommandHandler<AddSecretSantaUsersCommand> {
  ...
  async execute(command: AddSecretSantaUsersCommand): Promise<AddSecretSantaUsersResult> {
