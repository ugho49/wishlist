...
import { BaseRepository, PartialEntity } from '@wishlist/api/core'
import { camelCaseKeys, ItemId, UserId } from '@wishlist/common'

import { ItemEntity } from './item.entity'
import { NewItemsForWishlist } from './item.interface'

@Injectable()
export class LegacyItemRepository extends BaseRepository(ItemEntity) {
