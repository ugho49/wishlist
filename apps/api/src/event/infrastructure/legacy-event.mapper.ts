...
import type { EventEntity } from './legacy-event.entity'

import { toWishlistWithOwnerDto } from '@wishlist/api/wishlist'
import { DateTime } from 'luxon'

import { toAttendeeDto } from '../../attendee/infrastructure/legacy-attendee.mapper'
