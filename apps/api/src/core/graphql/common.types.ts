...
export function PagedResponse<T>(classRef: Type<T>): Type<{ resources: T[]; pagination: PaginationOutput }> {
  ...
  abstract class PagedResponseClass {
    ...
    declare pagination: PaginationOutput
  }
  return PagedResponseClass as Type<{ resources: T[]; pagination: PaginationOutput }>
}
